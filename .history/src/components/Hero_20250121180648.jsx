...
const Hero = () => {
    return (
        ...
        ><img style={{ width: "800px" }} className='col-span-6  ' src="https://www.seekpng.com/png/full/388-3886372_fashion-models-png.png" alt="" />
            <div className="absolute top-0 left-0 w-full h-full  opacity-50"></div>
            <div className="absolute col-span-6 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
