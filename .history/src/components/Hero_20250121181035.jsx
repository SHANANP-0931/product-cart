...
const Hero = () => {
    return (
        <section className="row" >
            <div className='col-6  '><img style={{ width: "800px" }} src="https://www.seekpng.com/png/full/388-3886372_fashion-models-png.png" alt="" /></div>
            <div className="absolute col-6 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
